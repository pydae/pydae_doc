...
def ini(struct,mode):
    ...
    if mode == 2:
        ...
        struct[0].f[0,0] = v_x
        struct[0].f[1,0] = v_y
        struct[0].f[2,0] = (-K_d*v_x + f_x - 2*lam*p_x)/M
        struct[0].f[3,0] = (-G*M - K_d*v_y - 2*lam*p_y)/M
    ...
    if mode == 3:
        ...
        struct[0].g[0,0] = -L**2 - 1.0e-6*lam + p_x**2 + p_y**2
        struct[0].g[1,0] = -theta + atan2(p_x, -p_y)
    ...
    if mode == 11:
        ...
        struct[0].Fy_ini[2,0] = -2*p_x/M 
        struct[0].Fy_ini[2,1] = 1/M 
        struct[0].Fy_ini[3,0] = -2*p_y/M 

        struct[0].Gx_ini[0,0] = 2*p_x
        struct[0].Gx_ini[0,1] = 2*p_y
        struct[0].Gx_ini[1,0] = -p_y/(p_x**2 + p_y**2)
        struct[0].Gx_ini[1,1] = p_x/(p_x**2 + p_y**2)
...
def run(t,struct,mode):
    ...
    if mode == 11:
        ...
        struct[0].Fy[2,0] = -2*p_x/M
        struct[0].Fy[3,0] = -2*p_y/M

        struct[0].Gx[0,0] = 2*p_x
        struct[0].Gx[0,1] = 2*p_y
        struct[0].Gx[1,0] = -p_y/(p_x**2 + p_y**2)
        struct[0].Gx[1,1] = p_x/(p_x**2 + p_y**2)
